...
<script>
    ...
    function updateSelectedOptionStyling() {
        const selectElement = document.getElementById('Tab');
        if (selectElement) {
            const selectedOption = selectElement.options[selectElement.selectedIndex];
            // Remove selected styling from all options
            for (let i = 0; i < selectElement.options.length; i++) {
                selectElement.options[i].classList.remove('text-sky-600','option-selected');
            }
            // Add selected styling to the currently selected option
            selectedOption.classList.remove('text-sky-600','option-selected');
            selectedOption.classList.add('option-selected','text-indigo-600');
        }
    }
</script>
